-- ============================================================================
-- ERP RODATECH · Motor de alertas v3
--
-- Corrige el destino de las alertas de crédito: enlazaban al listado de
-- cobranzas en lugar del comprobante afectado, de modo que al abrirlas se
-- llegaba a un tablero del módulo y no a la información del documento.
-- ============================================================================
