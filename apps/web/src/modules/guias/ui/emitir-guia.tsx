      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {guia.lineas.length === 1 ? "producto sale" : "productos salen"} del
            almacén y el kardex registra la salida. Deshacerlo es anular la
            guía, y eso solo lo puede hacer Gerencia.
          </DialogDescription>
        </DialogHeader>
        <DialogBody>
